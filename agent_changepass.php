                        				...
                        				<div class="col-md-12 padmarzero">
                                        	<ul  class="list-group">
                                               <li class="list-group-item"><a href="agent_managebooking.php"><?=MANAGE_MY_BOOKINGS?> » </a></li>
                                                ...
                                                <li class="list-group-item active"><a href="agent_changepass.php"><?=CHANGE_PASSWORD?>» </a></li>
...
<div class="container-fluid">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8">
                          <div class="form-group">	  
							  <input type="submit" name="changebtn" id="changebtn" value="<?=UPDATE?>" class="form-control searchbtn" />
...
$(document).ready(function(){
		...
		$('#changebtn').click(function(){
			if($('#new_pass').val() != "" && $('#con_pass').val() != ""){
				if($('#new_pass').val() == $('#con_pass').val()){ 
				var querystr = 'actioncode=10&old_pass='+$('#old_pass').val()+'&new_pass='+$('#new_pass').val();
