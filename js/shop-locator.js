    ...
    var pluginName = "ShopLocator",
        defaults = {
            ...
            infoBubble:{
                ...
                getDirectionsButtonName: "Book Now",
    ...
    $.extend(Plugin.prototype, {
        ...
        createMarkers: function(map, searchBox, markerTable, settings){
            ...
            var marker = new google.maps.Marker({
                ...
                icon: new google.maps.MarkerImage("images/map/"+markerTable.iconset)
            });
            var markerPosition = marker.getPosition();
            if(settings.infoBubble.getDirectionsButton == true){
                getDirectinButton = "<a class='ct-button--direction make-hidden' href='"+markerTable.url+"'>"+settings.infoBubble.getDirectionsButtonName+"</a>"; 
            }
            if(settings.infoBubble.visible == true) {
                var infoBubble = new InfoBubble({
                    ...
                    "<span>"+markerTable.city+" - "+markerTable.zip+"</span>"+
                    getDirectinButton+
                    "</div>",
