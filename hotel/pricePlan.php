...
?>
<script type="text/javascript" src="../admin/js/jquery.validate_pp.js"></script>
<script>
...
<div class="flat_area grid_16">
  <button class="button_colour round_all" onclick="window.location.href='<?=$_SERVER['HTTP_REFERER']?>'" style="float:right;"><img height="24" width="24" alt="Bended Arrow Right" src="../admin/images/icons/small/white/bended_arrow_right.png"><span>Back</span></button>
    ...
    <div class="block no_padding">
      <table cellpadding="4" cellspacing="0" width="100%">
        <?php
		 ...
		 ?>
       <input type="hidden" name="hotelid" id="hotelid" value="<?=$_SESSION['hhid']?>" />
        <tr>
          <td width="120px">Select Roomtype</td> 
        ...
        <tr>
          <td>Start Date</td>
          <td><table><tr><td><input type="text" readonly="readonly" name="startdate" id="txtFromDate" style="width:70px; margin-right:0px;" class="required"/></td><td>&nbsp;<a id="datepickerImage" href="javascript:;"><img src="../img/month.png" width="18px" height="18px"/></a></td></tr></table></td>
        </tr>
        <tr>
          <td>End Date</td>
          <td><table><tr><td><input type="text" readonly="readonly" name="enddate" id="txtToDate" style="width:70px; margin-right:0px;" class="required"/></td><td>&nbsp;<a id="datepickerImage1" href="javascript:;"><img src="../img/month.png" width="18px" height="18px"/></a></td></tr></table></td>
        </tr>
        <?php } ?>
      </table>
      <br />
       ...
       <table width="100%">
        <tr>
          ...
          <td><input type="hidden" name="submit_btn" value="1" />
            <button class="button_colour round_all"><img height="24" width="24" alt="Bended Arrow Right" src="../admin/images/icons/small/white/bended_arrow_right.png"><span>Submit</span></button></td>
        </tr>
      </table>
       <?php
		 }else{ 
