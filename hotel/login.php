    ...
    <form action="authenticate.php" method="post">
       ...
       <?php
		...
		?>
			...
			<label class="fields"><strong>Email ID</strong><input type="text" id="email_id" name="email_id" class="indent round_all"></label>
     ...
     <label class="fields"><strong>&nbsp;</strong><img src="../admin/captcha_code_file.php?rand=<?php echo rand(); ?>" id='captchaimg' ><br>
<span style="float:right">Can't read the image? click <a href='javascript: refreshCaptcha();' >here</a> to refresh</span>
       </label>
			<button class="button_colour round_all" ><img width="24" height="24" alt="Locked 2" src="../admin/images/icons/small/white/locked_2.png"><span>Login</span></button>
           <a href="#" id="login_logo"><img src="../images/clogo1.png"/></a> 
		</div>
         </form>
...
<script type="text/javascript" src="../admin/js/livevalidation/livevalidation_standalone.js"></script>		

<script type="text/javascript"> 

// Validation

        var email = new LiveValidation('email_id');
