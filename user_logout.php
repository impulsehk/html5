...
<title><?=$bsiCore->config['conf_portal_name']?> : Customer Logout </title>
</head>
                					...
                					<div class="row">
                        				<div class="col-md-12 searchbg">
                                            ...
                                            <div class="container-fluid" style="padding:20px 15px"> 
                                            	<div class="row">
                                                    <div class="col-md-12"><p class="pstl"><?php echo NEW_LOGOUT_MSG1;?>  <?php echo $bsiCore->config['conf_portal_name'];?>   <?php echo NEW_LOGOUT_MSG2;?><br /><br /><?php echo NEW_LOGOUT_MSG3;?></p></div>
