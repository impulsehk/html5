...
<table align="center" width="60%" cellspacing="0" cellpadding="0" border="0"  class="table1">
  ...
  <tr>
   ...
   <tr>
    <td class="table_content_l" align="right"><b>Folder for PDF Data:</b><br />
      <?php echo '"'.$bsiStep->installinfo['data_path'].'"'; ?></td>
    <td class="table_content_r" align="left"><?php 	
	if($bsiStep->installerror['data_notwritable']){ echo '<span class="red">Failed</span>';}
	else { echo '<span class="green">Passed</span>';}
	?></td>
  </tr>
  <tr>
