...
<table align="center" width="60%" cellspacing="0" cellpadding="0" border="0"  class="table1">
  ...
  <tr>
    ...
    <td class="table_content" colspan="2" align="center"><br />
      ...
      <p style="padding:5px;"><b> Congratulation, You have succesfully installed PHP BSI Multi Hotel Booking System Pro v1.0. </b></p></td>
  ...
  <tr>
    ...
    <td class="table_content" align="right"><b>Hotel Protal Link:</b></td>

    <td class="table_content" align="left"><a href="<?=$bsiStep->hotelSitePath?>">

      <?=$bsiStep->hotelSitePath?> 
  ...
  <tr>
    ...
    <td class="table_content" colspan="2" align="center"><br />
      ...
      <span style="padding:5px;"><b>Thank you for choosing PHP BSI Multi Hotel Booking System Pro.</b></span></td>
