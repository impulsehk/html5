    ...
    <div class="container">
      ...
      <div class="row posrel">
        ...
        <div class="col-md-4 col-sm-1 logodiv">
          <a href="index.php" class="logo"><img src="gallery/portal/<?= $bsiCore->config['conf_portal_logo'] ?>" alt=""/></a>
        </div>
              ...
              if (mysql_num_rows($resultMenu)) {
                ...
                while ($rowMenu = mysql_fetch_assoc($resultMenu)) {
                  ...
                  if (trim($rowMenu['url']) == "") {
                    ...
                    echo '<li class="has-sub"><a href="' . preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(" ", "-", strtolower(trim($rowMenu['cont_title'])))) . '-' . $rowMenu['id'] . '.html">' . $rowMenu['cont_title'] . '</a>';
                    ...
                    if (mysql_num_rows($resultSubMenu)) {
                      ...
                      while ($rowSubMenu = mysql_fetch_assoc($resultSubMenu)) {
                        ...
                        echo '<li><a href="' . preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(" ", "-", strtolower(trim($rowSubMenu['cont_title'])))) . '-' . $rowSubMenu['id'] . '.html">' . $rowSubMenu['cont_title'] . '</a></li>';
                      }
                    ...
                    echo ' <li><a href="' . $rowMenu['url'] . '" title="Home">' . $rowMenu['cont_title'] . '</a>';
           ...
           <?php /*?> <?php
              ...
              <ul class="nav navbar-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="user_managebooking.php"><?php echo NEW_BOOKING; ?></a></li>
                    <li><a href="user_editAccount.php"><?php echo NEW_PROFILE; ?></a></li>
                    <li class="divider"></li>
                    <li><a href="user_logout.php"><?php echo LOGOUT; ?></a></li>
                  </ul>
                </li>
            ...
            <?php
              ...
              if (isset($_SESSION['password_2012']) && $_SESSION['agent'] == 1) {
                ...
                <ul class="nav navbar-right">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="agent_managebooking.php"><?php echo NEW_BOOKING; ?></a></li>
                      <li><a href="agent_editAccount.php"><?php echo NEW_PROFILE; ?></a></li>
                      <li class="divider"></li>
                      <li><a href="agent_logout.php"><?php echo LOGOUT; ?></a></li>
                    </ul>
                  </li>
              ...
              <?php
                ...
                ?>
            <ul class="nav navbar-right auth-li">
