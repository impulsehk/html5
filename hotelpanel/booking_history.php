...
if($row['is_deleted'] == '0'){
	...
	if($bookingstatus['boking_status']==3){$stastus.='<span class="label label-csuccess">Check Out</span>';}
					...
					$html .= '<tr > 
								...
								<td  '.$alert.'>'.date("H:i:s",strtotime($row['bt'])).'</td>
								<td  '.$alert.'>'.$row['booking_time'].'</td>
								<td  '.$alert.'>'.$rooms1.'</td>
								<td  '.$alert.'>'.$bsiCore->currency_symbol().$amountdue.'</td>
								<td>'.$stastus.'</td>
								<td>
								<a href="javascript:;" onclick="myPopup2(\''.$row['booking_id'].'\');">Voucher</a>
                                                    ...
                                                    <div class="col-md-12" style="padding:0px;">
                                             			...
                                             			<div class="table-responsive">
                                                          <table class="table table-striped">
                                                          	<tr>
                                                             <th>Customer Name<br>客人姓名</th> 	 	 	 	 	
                                                             <th>Customer Phone<br>客人電話</th>
                                                             <th>Booking Time<br>訂房時間</th>
                                                             <th>Booking Date<br>訂房日期</th>
                                                             <th>Room Type<br>房型</th>
                                                             <th>Amount Due<br>欠款</th>
                                                             <th>Status<br>狀態</th>
                                                                <th></th>
                                                             </tr>
                					...
                					<div class="row">
                        				<div class="col-md-12 padmarzero">
                                        	<ul  class="list-group">
                                            	 ...
                                            	 <li class="list-group-item"><a href="booking_list.php">Booking List 今日客人表 » </a></li>
                                             	 <li class="list-group-item active"><a href="booking_history.php">Booking History 訂房紀錄 » </a></li>
												 <li class="list-group-item"><a href="hotel_logout.php">Logout 登出</a></li>
                                            </ul>
                                        </div>
                                    </div>  
                                </div>
