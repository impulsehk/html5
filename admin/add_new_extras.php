                    ...
                    <?php if((isset($_GET['addedit'])) && ($_GET['addedit'] == 1)){
							  ...
							  // echo $eid;die;
							   if($eid!=0){
								  ...
								  $row =mysql_fetch_assoc(mysql_query("select * from  `bsi_hotel_extras` where id='".$eid."'"));
                    	...
                    	<form name="category-frm" id="category-frm" method="post" action="<?=$_SERVER['PHP_SELF']?>" enctype="multipart/form-data">
                            ...
                            <tr>
                            	<td style="padding:0 0 0 15px;">
                                	<label>Extras Name : </label>
                                </td>
                                <td style="padding-left:25px;">
                                <input class="required" type="text" id="service_name" name="service_name" value="<?=$row['service_name']?>" style="width:250px;">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="padding-left:25px;">
                                <input class="required" type="text" id="price" name="price" style="width:50px;" value="<?=$row['service_price']?>" style="width:250px;">
                                <?php echo $bsiCore->currency_code();?></td>
                            </tr>
