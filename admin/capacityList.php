...
$(document).ready(function() {
	...
	function roomlist_generate(){
		...
		if($('#hotel_id').val() != 0){
			...
			var querystr = 'actioncode=9&hotelid='+$('#hotel_id').val();
			...
			$.post("admin_ajax_processor.php", querystr, function(data){						 
				...
				if(data.errorcode == 0){
					...
					$('#getCapacityList').html('<tr><td colspan=3>No Capacity Available in this hotel!</td></tr>');
...
<script language="javascript">
	...
	window.location="capacityList.php?delid="+delid
...
<div class="flat_area grid_16">
  ...
  <h2>Occupancy types<?php $id=base64_encode(0);?>

    <button class="button_colour" style="float:right; padding-right:0px; margin-right:0px;" onclick="javascript:window.location.href='add_edit_Capacity.php?id=<?=$id?>&addedit=1'"><img height="24" width="24" alt="Bended Arrow Right" src="images/icons/small/white/bended_arrow_right.png"><span>Add&nbsp;&nbsp;New&nbsp;&nbsp;Room&nbsp;&nbsp;Occupancy types</span></button>
    ...
    <table class="static" cellpadding="8">
      ...
      <thead>
        ...
        <tr>
          ...
          <th class="first" style="padding:0 0 0 10px; width:300px">Title</th>

          <th style="padding:0 0 0 10px; width:400px;">Occupancy</th>
