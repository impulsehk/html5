...
class MYPDF extends TCPDF {
    ...
    // Load table data from file
   	public function LoadData($data){
		...
		while($rowHotel=mysql_fetch_assoc($sqlQuery)){
			$rowcontry=mysql_fetch_assoc(mysql_query("select * from bsi_country where country_code='".$rowHotel['country_code']."'"));
		$rowHotelList.=$rowHotel['hotel_name'].";".$rowHotel['address_1'].";".$rowHotel['city_name'].";".$rowHotel['state'].";".$rowcontry['cou_name'].";".$rowHotel['post_code'].";".$rowHotel['email_addr'].";".$rowHotel['phone_number'].";".$rowHotel['fax_number'].";";
		}
    ...
    public function ColoredTable($header,$data) {
        ...
        $this->SetFont('', '');
        // Header
        $w = array(40, 45, 20, 30, 35, 16, 35, 23, 23);
...
//Column titles
$header = array('Hotel Name', 'Address', 'City', 'State', 'Country', 'Postcode', 'Email', 'Phone', 'Fax');
